...
module.exports = (app) => {
  app.route('/cards').get([authMiddleware.checkTokenMiddleware],cardController.getAll);
  ...
  app.route('/card').post([authMiddleware.checkTokenMiddleware],cardController.add);
};
